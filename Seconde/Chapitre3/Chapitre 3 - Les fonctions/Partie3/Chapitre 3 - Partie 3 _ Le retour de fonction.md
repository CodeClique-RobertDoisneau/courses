...
## INTRODUCTION
C'est souvent la partie la plus difficile à comprendre au début. Quelle est la différence entre `print()` et `return` ?
Imaginez que vous demandez à votre boulanger le prix d'une baguette.
